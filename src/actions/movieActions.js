...
export const listMovies = (term="",page=1) => async (dispatch) => {
  ...
  try {
    ...
    const { data } = await axios.get(`https://www.omdbapi.com/?s=${term}&page=${page}&type=movie&apikey=e8a14901`);
...
export const listMovieDetails = (imdbID) => async (dispatch) => {
 try {
    ...
    const { data } = await axios.get(`https://www.omdbapi.com/?i=${imdbID}&apikey=e8a14901`);
    dispatch({
